...
| 회원가입 | `/auth/signup` | 이름·이메일·기관명·기관구분, 개인정보 동의 모달, 비밀번호 강도 체크 |
...
| 기능 | 비고 |
|------|------|
| 프로필 조회 | 이름, 이메일, 기관명, 기관구분, 가입일 |
| 프로필 수정 | 이름, 기관명, 기관구분(운영기관/협력기관) 수정 |
...
| 사용자 관리 | `/admin/users` | 전체/대기 탭, 승인/거절, 역할 변경(super_admin 승격 시 기관구분 자동 변경) |
